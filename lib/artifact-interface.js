...
module.exports = {
	...
	init(web3, vault, miningLogger) {
        ...
        this.baseArtifactAddress = addresses.VRIG
        this.childArtifactAddress = addresses.VGPU

        this.artifactContract = new web3.eth.Contract(tokenContractJSON.abi, this.baseArtifactAddress);
        this.childContract = new web3.eth.Contract(childContractJSON.abi, this.childArtifactAddress);
	...
	await this.send( this.artifactContract.methods.configureChildren(artifactId, vgpus), this.baseArtifactAddress );
    },

    async addChildArtifact(artifactId, childArtifactId) {
	await this.send( this.artifactContract.methods.addChildArtifact(artifactId, childArtifactId), this.baseArtifactAddress );
    },

    async removeChildArtifact(artifactId, childArtifactId) {
        await this.send( this.artifactContract.methods.removeChildArtifact(artifactId, childArtifactId), this.baseArtifactAddress );
    },

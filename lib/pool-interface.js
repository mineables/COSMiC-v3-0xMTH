...
module.exports = {
    ...
    */
    ...
    async collectMiningParameters(minerEthAddress, previousMiningParameters) {
        ...
        response.challengeNumber, account.address, response.difficulty
...
/*
    ...
    async collectMiningParameters2(minerEthAddress, previousMiningParameters) {
        // create a client
...
*/
    ...
    async submitMiningSolution(addressFrom, minerEthAddress, solution_number, challenge_number, challenge_digest, target, difficulty) {
        ...
        var submitShare = {}
        submitShare.origin = addressFrom
        submitShare.challengeNumber = challenge_number
        submitShare.nonce = solution_number

        console.log('submitShare:' + JSON.stringify(submitShare))
...
/*
    async submitMiningSolution2(addressFrom, minerEthAddress, solution_number, challenge_number, challenge_digest, target, difficulty) {
